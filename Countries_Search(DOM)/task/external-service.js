...
(function (module) {
  ...
  const _countriesList = [
    {
      name: 'Ukraine',
      flagURL: 'https://countryflagsapi.com/png/ua',
    ...
    {
      name: 'Hungary',
      flagURL: 'https://countryflagsapi.com/png/hu',
      region: _regionsList.eu,
      area: 93028,
      capital: 'Budapest',
    ...
    {
      name: 'Belarus',
      flagURL: 'https://countryflagsapi.com/png/by',
      region: _regionsList.eu,
      area: 207600,
      capital: 'Minsk',
    ...
    {
      name: 'Croatia',
      flagURL: 'https://countryflagsapi.com/png/hr',
      region: _regionsList.eu,
      area: 56594,
      capital: 'Zagreb',
    ...
    {
      name: 'United States',
      flagURL: 'https://countryflagsapi.com/png/um',
      region: _regionsList.na,
      area: 9372610,
    ...
    {
      name: 'Bolivia',
      flagURL: 'https://countryflagsapi.com/png/bo',
      region: _regionsList.sa,
      area: 1098581,
      capital: 'Sucre',
      languages: {
    ...
    {
      name: 'Paraguay',
      flagURL: 'https://countryflagsapi.com/png/py',
      region: _regionsList.sa,
      area: 406752,
      capital: 'Asunci\u00f3n',
      languages: {grn: 'Guaran\u00ed', spa: 'Spanish'},
    ...
    {
      name: 'Tunisia',
      flagURL: 'https://countryflagsapi.com/png/tn',
      region: _regionsList.af,
      area: 163610,
      capital: 'Tunis',
      languages: {ara: 'Arabic'},
    ...
    {
      name: 'South Sudan',
      flagURL: 'https://countryflagsapi.com/png/sd',
      region: _regionsList.af,
      area: 619745,
      capital: 'Juba',
      languages: {eng: 'English'},
    ...
    {
      name: 'Algeria',
      flagURL: 'https://countryflagsapi.com/png/dz',
      region: _regionsList.af,
      area: 2381741,
      capital: 'Algiers',
      languages: {ara: 'Arabic'},
    ...
    {
      name: 'North Korea',
      flagURL: 'https://countryflagsapi.com/png/kp',
      region: _regionsList.as,
      area: 120538,
      capital: 'Pyongyang',
    ...
    {
      name: 'Australia',
      flagURL: 'https://countryflagsapi.com/png/at',
    ...
    {
      name: 'New Zealand',
      flagURL: 'https://countryflagsapi.com/png/nz',
      region: _regionsList.oc,
      area: 270467,
      capital: 'Wellington',
      languages: {
